...
class Reel:
    ...
    def animate(self, delta_time):
        if self.reel_is_spinning:
            ...
            if self.delay_time <= 0:
                ...
                # Itera a traves de todos los 5 simbolos
    ...
    def reel_spin_result(self):
        # Toma y retorna la representacion del simbolo
        spin_symbols = []
...
class Symbol(pygame.sprite.Sprite):
    def __init__(self, pathToFile, pos, idx):
        ...
        # Se usa para las animaciones de victoria
        self.size_x = 300
        self.size_y = 300
        self.alpha = 255
        self.fade_out = False
    ...
    def update(self):
        # Incrementa el tamano de los simbolos de victoria
        if self.fade_in:
            if self.size_x < 320:
                self.size_x += 1
                self.size_y += 1
