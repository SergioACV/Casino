...
class UI:
    ...
    def display_info(self):
        ...
        bet_surf = self.bet_font.render("Apuesta: $" + player_data['bet_size'], True, TEXT_COLOR, None)
        ...
        # Imprime la ultima victoria
        if self.player.last_payout:
            last_payout = player_data['last_payout']
            win_surf = self.win_font.render("Ganaste! $" + last_payout, True, TEXT_COLOR, None)
            x1 = 800
